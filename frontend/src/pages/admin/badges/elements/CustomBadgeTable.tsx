...
const CustomBadgeTable = ({ loading, error, badges }: CustomBadgeTableProps) => {
            ...
            <Tr backgroundColor="neutral.200" w="100%">
              <Th width="12%">
                <Flex alignItems="center" gap="8px">
                  <Text textStyle="web.s1" color="#000000" textTransform="none">Icon</Text>
                </Flex>
              </Th>
              <Th width="22%">
                <Flex alignItems="center" gap="8px">
                  <Text textStyle="web.s1" color="#000000" textTransform="none">Badge Name</Text>
                </Flex>
              </Th>
              <Th width="54%">
                <Flex alignItems="center" gap="8px">
                  <Text textStyle="web.s1" color="#000000" textTransform="none">Description</Text>
                </Flex>
              </Th>
              <Th width="12%">
                <Flex alignItems="center" gap="8px">
            ...
            { loading ? (
              ...
              badges.map((badge: any, index: number) => (
                ...
                >
                  ...
                  <Td>
                    <Text textStyle="web.b3" color="#000000">{badge.name}</Text>
                  </Td>
                  <Td>
                    <Text textStyle="web.b3" color="#000000">{badge.description}</Text>
                  </Td>
                  <Td>
