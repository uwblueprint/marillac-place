...
const ParticipantsModal = ({setOpen}: Props): React.ReactElement => {
    ...
    const onSubmit = () => {
        ...
        if (!participant.firstName || !participant.lastName || !participant.email || !participant.phoneNumber || 
            !participant.ID || !participant.password || !participant.arrivalDate) {
            ...
            <Flex flexDirection="column" gap="20px" >
                <Flex gap='20px'>
                    <Flex flexDir="column" flex="1">
                        <FormControl isRequired>
                            ...
                            <Input 
                                variant="primary" 
                                borderColor={submitPressed && !participant.firstName ? "#E30000BB" : "#C5C8D8"} 
                                boxShadow={submitPressed && !participant.firstName ? "0 0 2px #E30000BB" : "none"} 
                    ...
                    <Flex flexDir="column" flex="1">
                        <FormControl isRequired>
                            ...
                            <Input 
                                variant="primary" 
                                borderColor={submitPressed && !participant.lastName ? "#E30000BB" : "#C5C8D8"} 
                                boxShadow={submitPressed && !participant.lastName ? "0 0 2px #E30000BB" : "none"}
                ...
                <Flex gap='20px'>
                    <Flex flexDir="column" flex="1">
                        <FormControl isRequired>
                            ...
                            <Input 
                                variant="primary"
                                borderColor={submitPressed && !participant.email ? "#E30000BB" : "#C5C8D8"} 
                                boxShadow={submitPressed && !participant.email ? "0 0 2px #E30000BB" : "none"}
                                type="email" 
                    ...
                    <Flex flexDir="column" flex="1">
                        <FormControl isRequired>
                            ...
                            <Input
                                variant="primary"
                                borderColor={submitPressed && !participant.phoneNumber ? "#E30000BB" : "#C5C8D8"} 
                                boxShadow={submitPressed && !participant.phoneNumber ? "0 0 2px #E30000BB" : "none"}
                                type="tel" 
                ...
                <Flex>
                    <FormControl isRequired>
                        ...
                        <Input 
                            variant="primary"
                            borderColor={submitPressed && !participant.ID ? "#E30000BB" : "#C5C8D8"} 
                            boxShadow={submitPressed && !participant.ID ? "0 0 2px #E30000BB" : "none"}
                ...
                <Flex>
                    <FormControl isRequired>
                        ...
                        <InputGroup >
                            <Input
                                variant="primary"
                                borderColor={submitPressed && !participant.password ? "#E30000BB" : "#C5C8D8"}
                                boxShadow={submitPressed && !participant.password ? "0 0 2px #E30000BB" : "none"}
                ...
                <Flex gap='20px'>
                    <Flex flexDir="column" flex="1">
                        <FormControl isRequired>
                            ...
                            <Input 
                                variant="primary" 
                                borderColor={submitPressed && !participant.arrivalDate ? "#E30000BB" : "#C5C8D8"}
                                boxShadow={submitPressed && !participant.arrivalDate ? "0 0 2px #E30000BB" : "none"}
                ...
                <Flex justifyContent="flex-end">
                    <Button variant = "clear" marginRight="8px" onClick={() => setOpen(false)}>
                        Cancel
                    </Button>
