...
import { Text, Card, CardHeader, CardBody, Progress, Image, Flex, Button, Box } from "@chakra-ui/react";
	...
	{(goalExists) ?
	  (metGoal) ? (
		...
		height="40px"
	      />
	      <Text>
		Congratulations on completing your goal. Make sure to tell Marillac staff about your achievement.
	      </Text>
	    </Flex>
	  )
	    : <Flex
