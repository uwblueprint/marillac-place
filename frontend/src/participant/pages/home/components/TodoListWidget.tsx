  ...
  return  (
    <WidgetContainer>
      <>
        ...
        {!loading && !error && data && data.getAssignedTasksByParticipantIdAndDate.length !== 0 && (
          data.getAssignedTasksByParticipantIdAndDate.map((assigned_task: any) => {
            return (
              <Flex
              ...
              >
                ...
                <Text color="text.light.secondary" textStyle="mobile.b1">
                  {formatTimeRange(assigned_task.start_date, assigned_task.end_date)}
                </Text>
              </Flex>
            );
          })
