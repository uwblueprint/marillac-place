...
const variable: UserTypes = "STAFF";
const thing: Role = "User";
const greatUser = {
  id: "hi",
  firstName: "great",
  lastName: "user",
...
class UserService implements IUserService {
  ...
  async createUser(user: any): Promise<UserDTO> {
    // let newUser: User;
    // let firebaseUser: firebaseAdmin.auth.UserRecord;
  ...
  async updateUserById(userId: string, user: any): Promise<UserDTO> {
